...
#include <pcl/filters/crop_box.h> // remove robot points
...
//
// // Robot Box Sizes (center is velodyne)
// extern const float robotForwardX = 1.2;
// extern const float robotBackwardX = -0.5;
// extern const float robotRightY = -0.5;
// extern const float robotLeftY = 0.5;
// extern const float robotUpZ = 0.5;
// extern const float robotDownZ = -1.5;
//
//
// // Mapping Params
